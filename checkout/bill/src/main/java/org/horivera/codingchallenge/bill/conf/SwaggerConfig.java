...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(metaData()).select()
				.apis(RequestHandlerSelectors.basePackage("org.horivera.codingchallenge.bill.controller")).build();
	}

	private ApiInfo metaData() {
		return new ApiInfo("Bill Service", "API for Bill Service", "0.0.1", "Terms of service",
